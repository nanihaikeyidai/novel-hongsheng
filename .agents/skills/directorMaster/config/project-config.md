...
| Agents 目录 | `.agents\skills\`（项目级 skill 安装目录） |
| screenwriter skill | `.agents\skills\screenwriter\` |
| shotlist-builder skill | `.agents\skills\shotlist-builder\` |
| directorMaster skill | `.agents\skills\directorMaster\` |
